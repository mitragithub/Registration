...
% This code follows an ad hoc algorithm where an atlas is estimated by
% averaging neighboring slices, and then the atlas as aligned rigidly to
% each slice.  This code has been superceded by version 2, which uses a
% well posed algorithm.
% 
% arguments:  
